-- ============================================================================
-- CONSOLIDATED PATIENT INVOICES VIEW - SIMPLIFIED VERSION
-- ============================================================================
-- Run this script directly in PostgreSQL
-- psql -U skinspire_admin -d skinspire_dev -f create_consolidated_invoices_view_simple.sql
-- ============================================================================
...
SELECT
    ...
    -- === SOFT DELETE ===
    COALESCE(ih.is_deleted, FALSE) AS is_deleted,
    ih.deleted_at,
    ih.deleted_by
...
WHERE
    ...
    AND COALESCE(ih.is_deleted, FALSE) = FALSE
