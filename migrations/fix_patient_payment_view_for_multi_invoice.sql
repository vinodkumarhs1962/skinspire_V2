-- =====================================================================
-- Fix Patient Payment View for Multi-Invoice Payments
-- Get patient_id from AR subledger when invoice_id is NULL
-- =====================================================================
...
'Payment-centric view: ONE row per payment. For multi-invoice payments (invoice_id = NULL), patient info is retrieved from ar_subledger.';
