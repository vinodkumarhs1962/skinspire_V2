-- =====================================================================
-- Migration: Add advance_amount to supplier_payments_view
-- Date: 2025-11-02
-- Purpose: Fix payment detail view display issues by adding missing
--          advance_amount column to the database view
-- =====================================================================

-- Drop view if exists
DROP VIEW IF EXISTS supplier_payments_view CASCADE;

-- Recreate comprehensive supplier payments view with advance_amount
...
SELECT
    ...
    -- =====================================================================
    -- CRITICAL FIX: Amounts breakdown - NOW INCLUDES advance_amount
    -- =====================================================================
    ...
    COALESCE(sp.advance_amount, 0) AS advance_amount,  -- ADDED
    ...
    CASE
        ...
        WHEN sp.payment_method = 'advance' THEN 'Advance'  -- ADDED advance case
        ELSE 'Other'
...
-- =====================================================================
-- VERIFICATION: Check that advance_amount column exists
-- =====================================================================
SELECT
    column_name,
    data_type,
...
AND column_name IN ('cash_amount', 'cheque_amount', 'bank_transfer_amount', 'upi_amount', 'advance_amount')
