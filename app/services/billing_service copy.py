...
def _create_invoice(
    ...
    try:
        ...
        if prescription_items:
            ...
            # Store the relationship between the prescription items and the consolidated service
            # Implementation note: This can be added later if needed
...
def _void_invoice(
    ...
    try:
        ...
        # Instead of creating a negative invoice, mark this one as cancelled
        ...
        # Create a cancellation note in the history
        # (assuming you have an invoice history table)
...
#         logger.error(f"Error voiding invoice: {str(e)}")
#         session.rollback()
#         raise payment_count = session.query(PaymentDetail).filter_by(
#             hospital_id=hospital_id, invoice_id=invoice_id
#         ).count()
