...
def app():
    ...
    # Import the CSRF bypass function
    from tests.test_environment import get_csrf_bypass_flag
    
    # Determine CSRF setting from dedicated bypass flag
    csrf_enabled = not get_csrf_bypass_flag()
    ...
    app.config.update({
        ...
        'WTF_CSRF_ENABLED': csrf_enabled  # Based on dedicated CSRF bypass flag
    })
    
    # Log configuration details
    app.logger.info(f"Test application created with CSRF protection: {csrf_enabled}")
